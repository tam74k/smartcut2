...
export class AuthService {
    ...
    try {
      ...
      if (user.salonId) {
        ...
        if (s) {
          ...
          parsed.salonId = user.salonId;
          localStorage.setItem('smartcut_app_settings', JSON.stringify(parsed));
        }
      }
    } catch (e) {}
  }
  ...
  public static logout(): void {
    ...
    localStorage.removeItem('smartcut_active_salon_id');
  }
